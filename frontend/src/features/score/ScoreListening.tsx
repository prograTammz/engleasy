...
import { ListeningScore } from "@/models/score";
import { Label, Pie, PieChart } from "recharts";

type ScoreListeningProps = {
...
export const ScoreListening: React.FC<ScoreListeningProps> = ({
  listening_score,
}) => {
  const chartData = [
    {
      skill: "understanding_main_ideas",
      score: listening_score.understanding_main_ideas,
      fill: "var(--color-understanding_main_ideas)",
    },
    {
      skill: "understanding_details",
      score: listening_score.understanding_details,
      fill: "var(--color-understanding_details)",
    },
    {
      skill: "inference",
      score: listening_score.inference,
      fill: "var(--color-inference)",
    },
    {
      skill: "lexical_resource",
      score: listening_score.lexical_resource,
                    ...
                    if (viewBox && "cx" in viewBox && "cy" in viewBox) {
                      return (
                        ...
                        >
                          ...
                          >
                            {listening_score.total.toLocaleString()}
                          </tspan>
                          <tspan
                            x={viewBox.cx}
                            y={(viewBox.cy || 0) + 24}
        ...
        <CardContent>
          <ul className="flex flex-col gap-2 p-4">
            ...
            <li>
              ...
              The ability to make logical inferences from the listening
              material.
            </li>
            <li>
              <strong className="text-purple-500 dark:text-purple-300">
              ...
              Understanding of vocabulary used in the listening material.
            </li>
          </ul>
        </CardContent>
      </Card>
